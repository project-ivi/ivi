...
function setup(inputCode) {
    ...
    for (let i = 0; i < inputCode.length; i++) {
        if (inputCode[i].trim() != "") {
            output.push(interpretLine(inputCode[i]));
        }
    }
...
function interpretLine(inputLine) {
    ...
    currExpression = new Expression(inputLine);
